...
class Scraper:
	...
	def get_dates_and_shows_facebok(self):
		# use lxml library to get dates from html class tags
		self.ftree = html.fromstring(self.call.content)
		# create a list of dates using xpath
		self.fdates = self.ftree.xpath('//time[@class="list-card__date"]/text()')
		self.fevents = self.ftree.xpath('//div[@class="list-card__title"]/text()')
